...
def get_joint_combinations(chosen_joint):
    if chosen_joint == "LEFT_SHOULDER":
        ...
        return "RIGHT_ELBOW", "RIGHT_HAND", "RIGHT_WRIST"
    elif chosen_joint == "LEFT_WRIST":
        return "LEFT_ELBOW", "LEFT_HAND", "LEFT_WRIST"
        ...
        return "RIGHT_KNEE", "RIGHT_FOOT", "RIGHT_ANKLE"
    elif chosen_joint == "LEFT_ANKLE":
        return "LEFT_KNEE", "LEFT_FOOT", "LEFT_ANKLE"
